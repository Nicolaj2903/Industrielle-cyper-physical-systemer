...
public class Browse {
    public static void main(String[] args) {
        ...
        //Oprindelige endpoint, da Athilda oploade: opc.tcp://localhost:53530/OPCUA/SimulationServer

        try{
            List<EndpointDescription> endpoints = DiscoveryClient.getEndpoints("opc.tcp://LAPTOP-NU6AVTHI:53530/OPCUA/SimulationServer").get();
